...
public class OfwatLdapUserDetailsMapper implements UserDetailsContextMapper {
    // ~ Instance fields
    // ================================================================================================

    private final Log logger = LogFactory.getLog(OfwatLdapUserDetailsMapper.class);
    ...
    public UserDetails mapUserFromContext(DirContextOperations ctx, String username,
        ...
        this.logger.debug("Passed # authorities:" + authorities.size());
        ...
        logger.debug("Printing roleAttributes:");
        if(this.roleAttributes != null){
            logger.debug(this.roleAttributes.toString());
        }
        for (int i = 0; (this.roleAttributes != null)
                && (i < this.roleAttributes.length); i++) {
            logger.debug("Attribute:" + this.roleAttributes[i].toString());
        }
