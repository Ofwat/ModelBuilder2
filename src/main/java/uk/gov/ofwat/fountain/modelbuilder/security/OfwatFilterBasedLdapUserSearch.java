 ...
 * @see SearchControls
 */
public class OfwatFilterBasedLdapUserSearch implements LdapUserSearch {
    // ~ Static fields/initializers
    // =====================================================================================

    private static final Log logger = LogFactory.getLog(OfwatFilterBasedLdapUserSearch.class);
    ...
    public OfwatFilterBasedLdapUserSearch(String searchBase, String searchFilter,
    ...
    public DirContextOperations searchForUser(String username) {
        int trimAt = username.indexOf("@");
        String modifiedUser = username.substring(0, trimAt);

        if (logger.isDebugEnabled()) {
            logger.debug("Searching for user '" + username + ", modified user " + modifiedUser + "', with user search "
                    + this);
        }
        ...
        try {
            ...
            return template.searchForSingleEntry(searchBase, searchFilter,
                    new String[] { modifiedUser });

        }
        catch (IncorrectResultSizeDataAccessException notFound) {
            if (notFound.getActualSize() == 0) {
                throw new UsernameNotFoundException("User " + modifiedUser
