...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "ModelBuilder@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "ModelBuilder API";

        private String description = "ModelBuilder API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "ModelBuilder";
